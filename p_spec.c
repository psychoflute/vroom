...
void P_PlayerInSpecialSector (player_t* player)
{
	...
	break;
	  ...
	  case 9:
		...
		player->secretcount++;
		sector->special = 0;
		// Announce found secrets.
		extern int totalsecret;
		static char secret_msg_buf[64];
		sprintf(secret_msg_buf, "A secret is revealed! (%d/%d)", player->secretcount, totalsecret);
		player->message = secret_msg_buf;
